...
## 重要：使用下面的代码遇到了一个问题，就是运行后`HP laserjet M401d`打印机没有立即不打印，打印机上面显示"将介质装入纸盒1，普通纸 信封C4或按OK使用可用介质"，按了打印机上面的`ok`按钮后才打印。
<!--more-->
最后自己从 **[tabnine网站](https://www.tabnine.com/code/java/classes/javax.print.SimpleDoc)** 里面搜索相关代码以及查看网上打印的相关api后试验得到可以使用的如下代码
